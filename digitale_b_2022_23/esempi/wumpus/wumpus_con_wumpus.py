...
def update_fps():
    ...
    fps_text = font_fps.render(fps, 1, RED)
    return fps_text
...
tesoro = False
n = 1
font_messaggio_finale = pygame.font.SysFont("Comic Sans", 50)
testo_perso = font_messaggio_finale.render("Hai perso", True, WHITE)
testo_vinto = font_messaggio_finale.render("Hai vinto", True, WHITE)
...
while running == True:
    ...
    screen.blit(wumpus, (x * 50 - 50, y * 50 - 50))

    # QUI DISEGNIAMO IL TESTO DI VITTORIA / SCONFITTA
    if mostro == True:
        screen.blit(testo_perso, (10, 100))
    elif tesoro == True:
        screen.blit(testo_vinto, (10, 100))
